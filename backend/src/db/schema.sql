...
-- ======================================
-- 2. DATABASES TABLE (CSV Загрузки)
-- ======================================
...
CREATE TABLE IF NOT EXISTS call_filters (
  id SERIAL PRIMARY KEY,
  name VARCHAR(255) NOT NULL,
  database_ids INTEGER[] NOT NULL, -- массив ID баз
  user_ids INTEGER[], -- массив ID пользователей (NULL = все)
  statuses VARCHAR(50)[], -- массив статусов для фильтрации
...
VALUES ('admin', 'Главный Администратор', '$2b$10$XqAQO8F.q9vZZxh8r2eMWO5Y4MXY7VaJ4h7L.JeD.q8H2pKjVxO8e', 'admin')
